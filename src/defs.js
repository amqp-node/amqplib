...
function encodeConnectionStart(channel, fields) {
  ...
  len = encodeTable(SCRATCH, val, scratchOffset)
  var serverProperties_encoded = SCRATCH.slice(
    scratchOffset,
    scratchOffset + len
  )
  scratchOffset += len
...
function encodeConnectionStartOk(channel, fields) {
  ...
  len = encodeTable(SCRATCH, val, scratchOffset)
  var clientProperties_encoded = SCRATCH.slice(
    scratchOffset,
    scratchOffset + len
  )
  scratchOffset += len
...
export const encodeMethod = function (id, channel, fields) {
  switch (id) {
    case 3932170:
...
export const encodeProperties = function (id, channel, size, fields) {
  switch (id) {
    case 60:
...
export const methodInfoBasicQos = {
  id: 3932170,
  classId: 60,
  methodId: 10,
  name: 'BasicQos',
...
export const methodInfoBasicQosOk = {
  id: 3932171,
  classId: 60,
  methodId: 11,
  name: 'BasicQosOk',
...
export const methodInfoBasicConsume = {
  id: 3932180,
  classId: 60,
  methodId: 20,
  name: 'BasicConsume',
...
export const methodInfoBasicConsumeOk = {
  id: 3932181,
  classId: 60,
  methodId: 21,
  name: 'BasicConsumeOk',
...
export const methodInfoBasicCancel = {
  id: 3932190,
  classId: 60,
  methodId: 30,
  name: 'BasicCancel',
...
export const methodInfoBasicCancelOk = {
  id: 3932191,
  classId: 60,
  methodId: 31,
  name: 'BasicCancelOk',
...
export const methodInfoBasicPublish = {
  id: 3932200,
  classId: 60,
  methodId: 40,
  name: 'BasicPublish',
...
export const methodInfoBasicReturn = {
  id: 3932210,
  classId: 60,
  methodId: 50,
  name: 'BasicReturn',
...
export const methodInfoBasicDeliver = {
  id: 3932220,
  classId: 60,
  methodId: 60,
  name: 'BasicDeliver',
...
export const methodInfoBasicGet = {
  id: 3932230,
  classId: 60,
  methodId: 70,
  name: 'BasicGet',
...
export const methodInfoBasicGetOk = {
  id: 3932231,
  classId: 60,
  methodId: 71,
  name: 'BasicGetOk',
...
export const methodInfoBasicGetEmpty = {
  id: 3932232,
  classId: 60,
  methodId: 72,
  name: 'BasicGetEmpty',
...
export const methodInfoBasicAck = {
  id: 3932240,
  classId: 60,
  methodId: 80,
  name: 'BasicAck',
...
export const methodInfoBasicReject = {
  id: 3932250,
  classId: 60,
  methodId: 90,
  name: 'BasicReject',
...
export const methodInfoBasicRecoverAsync = {
  id: 3932260,
  classId: 60,
  methodId: 100,
...
export const methodInfoBasicRecover = {
  id: 3932270,
  classId: 60,
  methodId: 110,
  name: 'BasicRecover',
...
export const methodInfoBasicRecoverOk = {
  id: 3932271,
  classId: 60,
  methodId: 111,
  name: 'BasicRecoverOk',
...
export const methodInfoBasicNack = {
  id: 3932280,
  classId: 60,
  methodId: 120,
  name: 'BasicNack',
...
export const methodInfoConnectionStart = {
  id: 655370,
  classId: 10,
  methodId: 10,
...
export const methodInfoConnectionSecure = {
  id: 655380,
  classId: 10,
  methodId: 20,
...
export const methodInfoConnectionSecureOk = {
  id: 655381,
  classId: 10,
  methodId: 21,
...
export const methodInfoConnectionTune = {
  id: 655390,
  classId: 10,
  methodId: 30,
  name: 'ConnectionTune',
...
export const methodInfoConnectionTuneOk = {
  id: 655391,
  classId: 10,
  methodId: 31,
...
export const methodInfoConnectionOpen = {
  id: 655400,
  classId: 10,
  methodId: 40,
  name: 'ConnectionOpen',
...
export const methodInfoConnectionOpenOk = {
  id: 655401,
  classId: 10,
  methodId: 41,
...
export const methodInfoConnectionClose = {
  id: 655410,
  classId: 10,
  methodId: 50,
...
export const methodInfoConnectionCloseOk = {
  id: 655411,
  classId: 10,
  methodId: 51,
...
export const methodInfoConnectionBlocked = {
  id: 655420,
  classId: 10,
  methodId: 60,
...
export const methodInfoConnectionUnblocked = {
  id: 655421,
  classId: 10,
  methodId: 61,
...
export const methodInfoConnectionUpdateSecret = {
  id: 655430,
  classId: 10,
  methodId: 70,
...
export const methodInfoConnectionUpdateSecretOk = {
  id: 655431,
  classId: 10,
  methodId: 71,
...
export const methodInfoChannelOpen = {
  id: 1310730,
  classId: 20,
  methodId: 10,
  name: 'ChannelOpen',
...
export const methodInfoChannelOpenOk = {
  id: 1310731,
  classId: 20,
  methodId: 11,
  name: 'ChannelOpenOk',
...
export const methodInfoChannelFlow = {
  id: 1310740,
  classId: 20,
  methodId: 20,
  name: 'ChannelFlow',
...
export const methodInfoChannelFlowOk = {
  id: 1310741,
  classId: 20,
  methodId: 21,
  name: 'ChannelFlowOk',
...
export const methodInfoChannelClose = {
  id: 1310760,
  classId: 20,
  methodId: 40,
  name: 'ChannelClose',
...
export const methodInfoChannelCloseOk = {
  id: 1310761,
  classId: 20,
  methodId: 41,
  name: 'ChannelCloseOk',
...
export const methodInfoAccessRequest = {
  id: 1966090,
  classId: 30,
  methodId: 10,
  name: 'AccessRequest',
...
export const methodInfoAccessRequestOk = {
  id: 1966091,
  classId: 30,
  methodId: 11,
...
export const methodInfoExchangeDeclare = {
  id: 2621450,
  classId: 40,
  methodId: 10,
...
export const methodInfoExchangeDeclareOk = {
  id: 2621451,
  classId: 40,
  methodId: 11,
...
export const methodInfoExchangeDelete = {
  id: 2621460,
  classId: 40,
  methodId: 20,
  name: 'ExchangeDelete',
...
export const methodInfoExchangeDeleteOk = {
  id: 2621461,
  classId: 40,
  methodId: 21,
...
export const methodInfoExchangeBind = {
  id: 2621470,
  classId: 40,
  methodId: 30,
  name: 'ExchangeBind',
...
export const methodInfoExchangeBindOk = {
  id: 2621471,
  classId: 40,
  methodId: 31,
  name: 'ExchangeBindOk',
...
export const methodInfoExchangeUnbind = {
  id: 2621480,
  classId: 40,
  methodId: 40,
  name: 'ExchangeUnbind',
...
export const methodInfoExchangeUnbindOk = {
  id: 2621491,
  classId: 40,
  methodId: 51,
...
export const methodInfoQueueDeclare = {
  id: 3276810,
  classId: 50,
  methodId: 10,
  name: 'QueueDeclare',
...
export const methodInfoQueueDeclareOk = {
  id: 3276811,
  classId: 50,
  methodId: 11,
  name: 'QueueDeclareOk',
...
export const methodInfoQueueBind = {
  id: 3276820,
  classId: 50,
  methodId: 20,
  name: 'QueueBind',
...
export const methodInfoQueueBindOk = {
  id: 3276821,
  classId: 50,
  methodId: 21,
  name: 'QueueBindOk',
...
export const methodInfoQueuePurge = {
  id: 3276830,
  classId: 50,
  methodId: 30,
  name: 'QueuePurge',
...
export const methodInfoQueuePurgeOk = {
  id: 3276831,
  classId: 50,
  methodId: 31,
  name: 'QueuePurgeOk',
...
export const methodInfoQueueDelete = {
  id: 3276840,
  classId: 50,
  methodId: 40,
  name: 'QueueDelete',
...
export const methodInfoQueueDeleteOk = {
  id: 3276841,
  classId: 50,
  methodId: 41,
  name: 'QueueDeleteOk',
...
export const methodInfoQueueUnbind = {
  id: 3276850,
  classId: 50,
  methodId: 50,
  name: 'QueueUnbind',
...
export const methodInfoQueueUnbindOk = {
  id: 3276851,
  classId: 50,
  methodId: 51,
  name: 'QueueUnbindOk',
...
export const methodInfoTxSelect = {
  id: 5898250,
  classId: 90,
  methodId: 10,
  name: 'TxSelect',
...
export const methodInfoTxSelectOk = {
  id: 5898251,
  classId: 90,
  methodId: 11,
  name: 'TxSelectOk',
...
export const methodInfoTxCommit = {
  id: 5898260,
  classId: 90,
  methodId: 20,
  name: 'TxCommit',
...
export const methodInfoTxCommitOk = {
  id: 5898261,
  classId: 90,
  methodId: 21,
  name: 'TxCommitOk',
...
export const methodInfoTxRollback = {
  id: 5898270,
  classId: 90,
  methodId: 30,
  name: 'TxRollback',
...
export const methodInfoTxRollbackOk = {
  id: 5898271,
  classId: 90,
  methodId: 31,
  name: 'TxRollbackOk',
...
export const methodInfoConfirmSelect = {
  id: 5570570,
  classId: 85,
  methodId: 10,
  name: 'ConfirmSelect',
...
export const methodInfoConfirmSelectOk = {
  id: 5570571,
  classId: 85,
  methodId: 11,
