...
var CLIENT_PROPERTIES = {
  product: 'amqplib',
  version: '0.10.8', // puxar do package.json
...
export function connect(url, socketOptions, openCallback) {
  ...
  if (typeof url === 'object') {
    ...
    var parts = new URL(url) // yes, parse the query string
  ...
  if (protocol === 'amqp:') {
    sock = connectInsecure(sockopts, onConnect)
  } else if (protocol === 'amqps:') {
    sock = connectSecure(sockopts, onConnect)
  } else {
