...
import { credentialsFromUrl } from '../src/connect.js'

import * as defs from '../src/defs.js'

import util from './util.js'

import { amqplain, plain } from '../src/credentials.js'
...
const connectionString = process.env.URL || 'amqp://localhost:5672'
...
suite('Connect API', function () {
  ...
  test('using custom heartbeat option', function (done) {
    ...
    connect(
      config,
      {},
      kCallback(succeedIfAttributeEquals('heartbeat', 20, done), fail(done))
    )
  })
