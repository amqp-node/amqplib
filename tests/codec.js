...
var testCases = [
  ...
  [
    ...
    { short: -129 },
    [5, 115, 104, 111, 114, 116, 115, 255, 127]
  ],
  [
    '> 127 promoted to short',
    { short: 128 },
    [5, 115, 104, 111, 114, 116, 115, 0, 128]
  ],
  [
    '< 2^15 still a short',
    { short: 0x7fff },
  ...
  [
    ...
    { array: [6, true, 'foo'] },
    [
      5, 97, 114, 114, 97, 121, 65, 0, 0, 0, 12, 98, 6, 116, 1, 83, 0, 0, 0, 3,
      102, 111, 111
    ]
  ],
  [
  ...
  [
    ...
    [
      9, 116, 105, 109, 101, 115, 116, 97, 109, 112, 84, 0, 0, 1, 60, 0, 39,
      219, 23
    ]
  ],
  [
  ...
  [
    ...
    [
      13, 117, 110, 115, 105, 103, 110, 101, 100, 115, 104, 111, 114, 116, 117,
      255, 255
    ]
  ],
  [
    ...
    [
      11, 117, 110, 115, 105, 103, 110, 101, 100, 105, 110, 116, 105, 255, 255,
      255, 255
    ]
  ]
]
  ...
  for (var i = 0; i < args.length; i++) {
    ...
    try {
      if (originalValue === undefined) {
        ...
        // will be buffers.
        assert.deepEqual(
          arg.type === 'longstr' ? Buffer.from(arg.default) : arg.default,
          decodedValue
        )
      } else {
      ...
      assertionErr.message +=
        ' (frame ' + methodOrProps + ' field ' + arg.name + ')'
      throw assertionErr
    }
  }
