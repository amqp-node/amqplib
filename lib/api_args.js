...
/*
The channel APIs have similar signatures, and in particular, both need
AMQP fields prepared from the same arguments. The arguments
marshalling is done here. Each of the procedures below takes arguments
particular to the operation it represents, and returns a `fields`
object for handing to the encoder.
*/
