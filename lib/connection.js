...
function isConnectionForced(error) {
  return !!error && (error.code === defs.constants.CONNECTION_FORCED)
}
...
module.exports.isProtocolError = isProtocolError;
module.exports.isConnectionForced = isConnectionForced;
