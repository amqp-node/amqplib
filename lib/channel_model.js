...
C.recoverQueues = function() {
  if(this.book !== undefined && this.book.queues !== undefined) {
    ...
    return Promise.each(keys, function(queue, index, length){
      var queue_is_anonymous = queues[queue].anonymous;
      var queue_options = queues[queue].options;
      var qname = queue;
      if(queue_is_anonymous) {
        qname = '';
      }
      return self.assertQueue(qname, queue_options)
                 .then(function(declareok){
                   var new_qname = declareok.queue;
                   if(qname !== new_qname){
                     self.rename_queue(qname, new_qname);
                   }
                   return declareok;
                 });
    });
...
C.assertQueue = function(queue, options) {
  ...
  return this.rpc(defs.QueueDeclare,
              ...
              .then(function(qok){
                ...
                self.record_queue(queue, anonymous, options);
                return qok;
              });
};
...
C.bindQueue = function(queue, source, pattern, argt) {
  ...
  return this.rpc(defs.QueueBind,
              ...
              .then(function(bindok){
                self.record_binding("queue", queue, source, pattern, argt);
                return bindok;
              });
};
...
C.unbindQueue = function(queue, source, pattern, argt) {
  ...
  return this.rpc(defs.QueueUnbind,
              ...
              .then(function(unbindok){
                self.remove_binding("queue", queue, source, pattern, argt);
                return unbindok;
              });
};
...
C.assertExchange = function(exchange, type, options) {
  ...
  return this.rpc(defs.ExchangeDeclare,
    ...
    .then(function(_ok) {
      self.record_exchange(exchange, type, options);
...
C.bindExchange = function(dest, source, pattern, argt) {
  ...
  return this.rpc(defs.ExchangeBind,
                  ...
                  defs.ExchangeBindOk)
              .then(function(bindok){
                self.record_binding("exchange", dest, source, pattern, argt);
                return bindok;
              });
};
...
C.unbindExchange = function(dest, source, pattern, argt) {
  ...
  return this.rpc(defs.ExchangeUnbind,
              ...
              .then(function(unbindok){
                self.remove_binding("exchange", dest, source, pattern, argt);
                return unbindok;
              });
};
...
C.consume = function(queue, callback, options) {
  ...
  .then(function(ok) {
    ...
    self.record_consumer(ok.fields.consumerTag, queue, callback, options);
    return ok.fields;
  });
};
...
C.cancel = function(consumerTag) {
  ...
  .then(function(ok) {
    ...
    self.remove_consumer(consumerTag);
    return ok.fields;
  });
};
...
C.prefetch = C.qos = function(count, global) {
  this.record_prefetch(count, global);
