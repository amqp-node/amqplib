...
C.record_consumer = function(tag, queue, callback, options){
  this.ensureConsumersBooked();
  var saved_options = Object.assign({}, options);
  this.book.consumers[tag] = {queue: queue, callback: callback, options: saved_options};
};

C.remove_consumer = function(tag){
  delete this.book.consumers[tag];
};

C.ensureConsumersBooked = function(){
...
C.recoverConsumers = function(callback) {
