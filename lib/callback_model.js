...
Channel.prototype.recoverChannel = function(cb){
  this.revalidate();
  var self = this;
...
Channel.prototype.record_consumer = function(tag, queue, callback, options){
  this.ensureConsumersBooked();
  this.book.consumers[tag] = {queue: queue, callback: callback, options: options};
};

Channel.prototype.remove_consumer = function(tag){
  delete this.book.consumers[tag];
};

Channel.prototype.ensureConsumersBooked = function(){
