...
// TODO: remove once all fn-classes are converted to classes
const {inherits} = require('util');
const EventEmitter = require('events');
const Promise = require('bluebird');
const defs = require('./defs.js');
const {BaseChannel} = require('./channel.js');
const {acceptMessage} = require('./channel.js');
const Args = require('./api_args.js');
...
class CallbackModel extends EventEmitter {
  constructor (connection) {
    ...
    for (const evt of ['error', 'close', 'blocked', 'unblocked']) {
      connection.on(evt, this.emit.bind(this, evt))
    }
  }
...
// TODO: convert to class once `BaseChannel` is a class that can be extended
...
// TODO: convert to class once `Channel` is a class that can be extended
