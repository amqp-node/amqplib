...
BaseChannel.prototype.record_consumer = function(tag, queue, callback, options) {
...
BaseChannel.prototype.remove_consumer = function(tag) {
  this.ensureConsumersBooked();
...
BaseChannel.prototype.record_prefetch = function(count, global) {
...
BaseChannel.prototype.record_queue = function(queue, anonymous, options) {
  this.ensureQueuesBooked();
  var saved_options = cloneObject(options);
  this.book.queues[queue] = {anonymous: anonymous, options: saved_options};
};

BaseChannel.prototype.remove_queue = function(queue) {
  this.ensureQueuesBooked();
...
BaseChannel.prototype.record_exchange = function(exchange, type, options) {
  this.ensureExchangesBooked();
  var saved_options = cloneObject(options);
  this.book.exchanges[exchange] = {type: type, options: saved_options};
};

BaseChannel.prototype.remove_exchange = function(exchange) {
  this.ensureExchangesBooked();
...
BaseChannel.prototype.record_binding = function(type, destination, source, pattern, args) {
  this.ensureBindingsBooked();
  var saved_args = cloneObject(args);
  this.remove_binding(type, destination, source, pattern, args);
...
BaseChannel.prototype.remove_binding = function(type, destination, source, pattern, args) {
  this.ensureBindingsBooked();
...
BaseChannel.prototype.rename_queue = function(old_name, new_name) {
  this.ensureBindingsBooked();
  this.ensureConsumersBooked();
  this.ensureQueuesBooked();
