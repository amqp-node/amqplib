...
function decodeFields(slice) {
    ...
    function decodeFieldValue() {
        ...
        case 'b':
            ...
            break;
        case 'S':
            len = slice.readUInt32(offset); offset +=4;
            val = slice.toString(offset, offset + len, 'utf8');
            offset += len;
            break;
        case 'I':
        ...
        case 'D': // only positive decimals, apparently.
            ...
            val = {places: places, digits: digits};
            break;
        case 'T':
        ...
        case 'f':
            ...
            break;
        case 'l':
            val = slice.readInt64BE(offset); offset += 8;
            break;
        case 's':
    ...
    while (offset < size) {
        ...
        key = buffer.toString(offset, offset + len, "utf8");
        offset += len;
        decodeFieldValue();
        fields[key] = val;
    }
