...
const { encodeTable, decodeFields } = codec

export const SCRATCH = Buffer.alloc(65536)
...
export function encodeMethod(id, channel, fields) {
  switch (id) {
   case 3932170:
...
export function encodeProperties(id, channel, size, fields) {
  switch (id) {
   case 60:
